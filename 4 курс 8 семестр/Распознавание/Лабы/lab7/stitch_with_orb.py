...
def stitch_panorama_correctly(image_paths):
    ...
    orb = cv2.ORB_create(nfeatures=2000)  # Можно настроить количество признаков
...
if __name__ == "__main__":
    ...
    if panorama is not None:
        ...
        cv2.imwrite('stitched_panorama_orb.jpg', panorama)
        print(f"\nПанорама сохранена: stitched_panorama_orb.jpg")
